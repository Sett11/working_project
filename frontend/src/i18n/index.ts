    ...
    resources: {
      ru: {
        ...
        dashboard: {
          ...
          users_admin_only: 'Доступ к списку пользователей имеют только администраторы',
          ...
          select_air_conditioners: 'Выбор кондиционеров',
          select_components: 'Выбор комплектующих',
          air_conditioner_selection_coming_soon: 'Функционал выбора кондиционеров будет реализован в следующих шагах',
          components_selection_coming_soon: 'Функционал выбора комплектующих будет реализован в следующих шагах',
        },
      auth: {
        login: 'Вход',
        ...
        landing: {
          hero_title: 'Автоматизация продаж и обслуживания кондиционеров',
          hero_subtitle: 'Уникальное решение учитывающее особенности бизнеса',
      ...
      en: {
        ...
        dashboard: {
          ...
          // Users
          all_users: 'All Users',
          users_admin_only: 'Only administrators have access to the user list',
          ...
          select_air_conditioners: 'Select Air Conditioners',
          select_components: 'Select Components',
          air_conditioner_selection_coming_soon: 'Air conditioner selection functionality will be implemented in the next steps',
          components_selection_coming_soon: 'Components selection functionality will be implemented in the next steps',
        },
      auth: {
        login: 'Login',
        register: 'Register',
        ...
        landing: {
          hero_title: 'Automation of air conditioner sales and service',
          hero_subtitle: 'A unique solution tailored to your business',
