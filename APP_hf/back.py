...
async def upload_file(file: UploadFile = File(...), anonymize_names: bool = Form(...), save_datetime: bool = Form(...)):
    ...
    text, _ = content_pre_process(clean_path, anonymize_names, save_datetime)
