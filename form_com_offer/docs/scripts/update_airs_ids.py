...
# -*- coding: utf-8 -*-
"""
Скрипт для обновления ID кондиционеров в файле new_airs.json
Начинает с ID 304 и продолжает по порядку: 305, 306, 307...
"""
...
def update_airs_ids():
    """
    Обновляет ID всех кондиционеров в файле new_airs.json
    Начинает с ID 304 и продолжает по порядку
    """
    
    # Путь к файлу new_airs.json
    script_dir = Path(__file__).parent
    project_root = script_dir.parent.parent
    airs_file = project_root / "docs" / "new_airs.json"
    ...
    try:
        # Читаем файл
        print("📖 Читаем файл new_airs.json...")
...
def main():
    """Главная функция"""
    print("🚀 Скрипт обновления ID кондиционеров")
    print("=" * 50)
